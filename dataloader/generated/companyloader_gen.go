...
func (l *CompanyLoader) unsafeSet(key int64, value *model.Company) {
	if l.cache == nil {
		l.cache = map[int64]*model.Company{}
	}
	l.cache[key] = value
}
...
func (b *companyLoaderBatch) keyIndex(l *CompanyLoader, key int64) int {
