...
type CompanyStringLoader struct {
	...
	batch *companyStringLoaderBatch

	// mutex to prevent races
	mu sync.Mutex
}

type companyStringLoaderBatch struct {
	keys    []string
	data    []*model.Company
	error   []error
	closing bool
...
func (l *CompanyStringLoader) LoadThunk(key string) func() (*model.Company, error) {
	...
	if l.batch == nil {
		l.batch = &companyStringLoaderBatch{done: make(chan struct{})}
	}
	batch := l.batch
...
func (l *CompanyStringLoader) unsafeSet(key string, value *model.Company) {
	if l.cache == nil {
...
func (b *companyStringLoaderBatch) keyIndex(l *CompanyStringLoader, key string) int {
...
func (b *companyStringLoaderBatch) startTimer(l *CompanyStringLoader) {
	time.Sleep(l.wait)
	l.mu.Lock()
...
func (b *companyStringLoaderBatch) end(l *CompanyStringLoader) {
