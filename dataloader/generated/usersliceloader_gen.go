...
func (l *UserSliceLoader) unsafeSet(key int64, value []*model.User) {
	if l.cache == nil {
		l.cache = map[int64][]*model.User{}
	}
	l.cache[key] = value
}
...
func (b *userSliceLoaderBatch) keyIndex(l *UserSliceLoader, key int64) int {
